...
<head>
    ...
    <title>Consulta Hogar - Búsqueda MEF</title>
                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header bg-primary text-white">
                            <h4 class="mb-0">🔍 Búsqueda de Información MEF</h4>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="tab-content mt-3" id="searchTabsContent">
                                ...
                                <div class="tab-pane fade show active" id="folioTab" role="tabpanel">
                                    <form id="folioForm" method="POST" action="{{ route('searchMef.process') }}" class="search-form">
                                        @csrf
                                ...
                                <div class="tab-pane fade" id="documentTab" role="tabpanel">
                                    <form id="documentForm" method="POST" action="{{ route('searchMef.process') }}" class="search-form">
                                        @csrf
                                        <div class="input-group">
                                            <input type="text"
                                                   class="form-control"
    ...
    <script>
        ...
        function showDetails(folio) {
            ...
            document.getElementById('hogarTab').innerHTML = `
                <div class="card">
                    <div class="card-body">
                        <h5>Información del Hogar ${folio}</h5>
                        <p><strong>Dirección:</strong> Calle Principal 123</p>
                        <p><strong>Teléfono:</strong> (123) 456-7890</p>
                        <p><strong>Estrato:</strong> 2</p>
                    </div>
                </div>
            `;
